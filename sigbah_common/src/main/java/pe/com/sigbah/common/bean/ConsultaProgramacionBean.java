 ...
 */
public class ConsultaProgramacionBean extends BaseOutputBean {
	...
	private Double totalAlimento;
	private Double totalBna;
	
	private Integer idUsuarioUsu;
	 ...
	 * 
	 */
	public ConsultaProgramacionBean() {
		super();
	}
	/**
	 * @param idProgramacion
	 */
	public ConsultaProgramacionBean(Integer idProgramacion) {
		super();
	...
	/**
	 * @return the totalAlimento
	 */
	public Double getTotalAlimento() {
		return totalAlimento;
	}
	/**
	 * @param totalAlimento the totalAlimento to set
	 */
	public void setTotalAlimento(Double totalAlimento) {
		this.totalAlimento = totalAlimento;
	}
	/**
	 * @return the totalBna
	 */
	public Double getTotalBna() {
		return totalBna;
	}
	/**
	 * @param totalBna the totalBna to set
	 */
	public void setTotalBna(Double totalBna) {
		this.totalBna = totalBna;
	}
	/**
	 * @return the usuariosCorreo
	 */
	public String getUsuariosCorreo() {
		return usuariosCorreo;
	}
	/**
	 * @param usuariosCorreo the usuariosCorreo to set
	 */
	public void setUsuariosCorreo(String usuariosCorreo) {
		this.usuariosCorreo = usuariosCorreo;
	}
	/**
	 * @return the idUsuarioUsu
	 */
	public Integer getIdUsuarioUsu() {
		return idUsuarioUsu;
	}
	/**
	 * @param idUsuarioUsu the idUsuarioUsu to set
	 */
	public void setIdUsuarioUsu(Integer idUsuarioUsu) {
		this.idUsuarioUsu = idUsuarioUsu;
	}
	/**
	 * @return the usuarioUsu
	 */
	...
	/**
	 * @param emailUsu the emailUsu to set
	 */
