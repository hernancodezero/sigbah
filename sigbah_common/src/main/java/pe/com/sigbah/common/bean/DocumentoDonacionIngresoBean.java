...
/**
 * @className: DocumentoDonacionBean.java
 * @description: 
 * @date: 18 de jul. de 2017
 * @author: ARCHY.
 */
public class DocumentoDonacionIngresoBean extends BaseOutputBean {
	 ...
	 * 
	 */
	public DocumentoDonacionIngresoBean() {
		super();
	}

	public DocumentoDonacionIngresoBean(Integer idDocumentoDonacion) {
		super();
