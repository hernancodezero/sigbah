...
<script src="${pageContext.request.contextPath}/resources/js/donaciones/listar_reportes_siga.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/donaciones/validacion_reportes_siga.js"></script>