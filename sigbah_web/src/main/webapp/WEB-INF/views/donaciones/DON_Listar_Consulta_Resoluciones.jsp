...
<div id="ribbon">
	...
	<ol class="breadcrumb">
		<li>Donaciones</li>
		<li>Consultas</li>
		<li>Resoluciones Jefaturales</li>
	</ol>
	<!-- end breadcrumb -->
</div>
<!-- END RIBBON -->
			...
			<article class="col-xs-12 col-sm-12">
				...
				<div class="jarviswidget">
					<header>
						...
						<h2>Búsqueda de Resoluciones</h2>
					</header>
						...
						<div class="widget-body widget-body-50">
							...
							<form id="frm_con_donaciones" class="form-horizontal">
								...
								<div class="form-group">
									...
									<label class="col-sm-3 control-label">Origen Donación:</label>
			...
			<article class="col-xs-12 col-sm-12">
				...
				<div class="jarviswidget jarviswidget-color-blueLight">
					...
					<header>
						...
						<h2>Resoluciones Jefaturales de Aceptación</h2>
								...
								<table id="tbl_productos" class="table table-bordered table-hover tbl-responsive">
									<thead>			                
										<tr>
											...
											<th class="opc-center">N° Resolución Jefatural</th>
											<th class="opc-center">Fecha Resolución</th>
											<th class="opc-center">Descripción</th>
											<th class="opc-center">Donante</th>
											<th class="opc-center">Código Donación</th>
											<th class="opc-center">Valor Moneda de Origen</th>
											<th class="opc-center">Documento de Inafectación Tributaria</th>
...
<script src="${pageContext.request.contextPath}/resources/js/donaciones/listar_consulta_resoluciones.js"></script>
