								...
								<div class="form-group" id="div_busqueda_alm_ext" style="display: none;">
									...
									<div id="divRegiones">
										...
										<div id="div_gob_destino_bus" class="row" >
											<label class="col-sm-3 control-label">Pertenece a:</label>
...
<!-- 								</a> -->
					...
					<div>
						...
						<div class="widget-body">
							...
							<div id="div_tbl_correlativo" style="display: none;" class="opc-center">
								<table id="tbl_correlativo" class="table table-bordered table-hover tbl-responsive">
									<thead>			                
										<tr>
											<th></th>
											<th class="opc-center">Almacén</th>
											<th class="opc-center">N° Serie</th>
											<th class="opc-center">N° Inicial</th>
											<th class="opc-center">N° Final</th>
											<th class="opc-center">N° Actual</th>
											<th class="opc-center">Nombre Imprenta</th>
											<th class="opc-center">Ruc Imprenta</th>
											<th class="opc-center">Nro Autorización</th>
											<th class="opc-center">Estado</th>
										</tr>
									</thead>
								</table>
					...
					<div class="col-xs-12 col-sm-12">
						<form id="frm_donante" class="form-horizontal" role="form">
							...
							<div class="form-group">																				
								...
								<div class="col-sm-4 form-group">
									<input type="text" name="txt_doc_donante" id="txt_doc_donante" class="form-control" maxlength="11">
								</div>
							</div>
...
<!-- Modal -->
<div id="div_chofer" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" id="btn_clo_anio" class="close" data-dismiss="modal" aria-hidden="true">
				...
				<h4 class="modal-title label-bold1" id="h4_tit_chofer">Año</h4>
			</div>
			
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 col-sm-12">
						<form id="frm_chofer" class="form-horizontal" role="form">
							
							<input type="hidden" id="hid_id_chofer" name="hid_id_chofer">
							...
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Chofer/Piloto/Capitán:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_nom_cho" id="txt_nom_cho" class="form-control">
								</div>
							</div>
							<div class="form-group">																				
								<label class="col-sm-3 control-label">DNI:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_dni_cho" id="txt_dni_cho" class="form-control">
								</div>
							</div>
							
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Brevete/otro:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_bre_cho" id="txt_bre_cho" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Estado:</label>
								<div class="col-sm-4 form-group">
									<select id="sel_est_cho" name="sel_est_cho" class="form-control">
										<option value="1">Activo</option>
										<option value="0">Inactivo</option>
									</select>
								</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btn_gra_cho">
					<i class="fa fa-floppy-o"></i>
					Aceptar
				</button>
...
<!-- Modal -->
<div id="div_correlativo" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" id="btn_clo_anio" class="close" data-dismiss="modal" aria-hidden="true">
				...
				<h4 class="modal-title label-bold1" id="h4_tit_correlativo">Actualizar Correlativo Guía de Remisión</h4>
			</div>
			
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 col-sm-12">
						<form id="frm_correlativo" class="form-horizontal" role="form">
							
							<input type="hidden" id="hid_id_correlativo" name="hid_id_correlativo">
							<input type="hidden" id="hid_flag_activo_corr" name="hid_flag_activo_corr">
							<input type="hidden" id="hid_activa_formato_corr" name="hid_activa_formato_corr">
							<input type="hidden" id="hid_cod_tip_corr" name="hid_cod_tip_corr">
							<input type="hidden" id="hid_id_almacen_corr" name="hid_id_almacen_corr">
					
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Nombre Almacén:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_nom_alm_corr" id="txt_nom_alm_corr" class="form-control" disabled>
								</div>
							</div>
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Nro Serie:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_nro_serie_corr" id="txt_nro_serie_corr" class="form-control input-number" maxlength="3">
								</div>
							</div>
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Nro de Inicio:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_nro_inicio_corr" id="txt_nro_inicio_corr" class="form-control input-number" maxlength="6">
								</div>
							</div>
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Nro Final:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_nro_final_corr" id="txt_nro_final_corr" class="form-control input-number" maxlength="6">
								</div>
							</div>
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Nro Actual:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_nro_actual_corr" id="txt_nro_actual_corr" class="form-control input-number" maxlength="6">
								</div>
							</div>
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Nro Autorización:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_nro_aut_corr" id="txt_nro_aut_corr" class="form-control" maxlength="20">
								</div>
							</div>
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Nombre Imprenta:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_nom_imp_corr" id="txt_nom_imp_corr" class="form-control">
								</div>
							</div>
							<div class="form-group">																				
								<label class="col-sm-3 control-label">Ruc Imprenta:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_ruc_imp_corr" id="txt_ruc_imp_corr" class="form-control input-number" maxlength="11">
								</div>
							</div>
							<div class="form-group">	
								...
								<div class="col-sm-3 smart-form form-group">
									<label class="input"> 
										...
										<input type="text" name="txt_fecha_ini_corr" id="txt_fecha_ini_corr" class="datepicker" readonly>
									</label>
								</div>
							</div>
<!-- 							<div class="form-group" > -->
<!-- 								<label class="col-sm-8 control-label">Activar Formato de Guía de Remisión Pre-Impreso:</label> -->
								
<!-- 								<div class="col-sm-4 form-group"> -->
<!-- 									<label class="radio radio-inline"> -->
<!-- 										<input type="radio" name="rb_correlativo" value="1"> -->
<!-- 										SI -->
<!-- 									</label> -->
									
<!-- 									<label class="radio radio-inline"> -->
<!-- 										<input type="radio" name="rb_correlativo" value="0"> -->
<!-- 										NO -->
<!-- 									</label>																		 -->
<!-- 								</div> -->
<!-- 							</div> -->
							<div class="form-group">
								<label class="col-sm-3 control-label">Estado:</label>
								<div class="col-sm-4 form-group">
									<select id="sel_est_correlativo" name="sel_est_correlativo" class="form-control">
										<option value="1">Activo</option>
										<option value="0">Inactivo</option>
									</select>
								</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btn_gra_cor">
					<i class="fa fa-floppy-o"></i>
					Aceptar
				</button>
...
<script> var dataAlmacen = JSON.parse('${dataAlmacen}'); </script>
