...
<!-- 											</div> -->
								...
								<div class="form-group" id="div_busqueda_poblacion_inei" style="display: none;">
									
									<div id="divPoblacionInei">
														
										
										<div id="div_pobla" class="row">
											<label class="col-sm-2 control-label">Año:</label>
											<div class="col-sm-2 form-group">
												<select id="sel_anio_inei" name="sel_anio_inei" class="form-control">
											...
											<label class="col-sm-2 control-label">Departamento:</label>
											<div class="col-sm-2 form-group">
												<select id="sel_departamento_inei" name="sel_departamento_inei" class="form-control">
													<option value="">Seleccione</option>
													<c:forEach items="${lista_departamento}" var="item">
														<option value="${item.coddpto}">${item.nombre}</option>
													</c:forEach>
									...
									<div class="col-sm-2">
										<button class="btn btn-primary" type="button" id="btn_buscar_poblacion_inei">
											<i class="fa fa-search"></i>
											Buscar
										</button>
									</div>
...
<!-- 								</a> -->
								...
								<a href="#" id="href_req_descargar" class="button-icon" rel="tooltip" title="" data-placement="bottom" 
									data-original-title="Descargar formato Inei">
					...
					<div>
						...
						<div class="widget-body">
							...
							<div id="div_tbl_marca" style="display: none;" class="opc-center">
								<table id="tbl_marca" class="table table-bordered table-hover tbl-responsive">
									<thead>			                
										<tr>
											<th></th>
											<th class="opc-center">N°</th>
...
<!-- 										<label class="col-sm-3 control-label">Tipo de Atención:</label> -->
										...
										<div class="col-sm-8 form-group" id="div_gore_local">
											<label class="radio radio-inline">
					...
					<div class="col-xs-12 col-sm-12">
						<form id="frm_det_documentos" class="form-horizontal" role="form">
							...
							<div class="form-group">																				
								...
								<div class="col-sm-8">
									<select id="sel_anio_inei_subir" name="sel_anio_inei_subir" class="form-control">
										<c:forEach items="${lista_anio}" var="item">
											<option value="${item.vcodigo}">${item.descripcion}</option>
										</c:forEach>
									</select>
					...
					<div class="col-xs-12 col-sm-12">
						<form id="frm_unidad_medida" class="form-horizontal" role="form">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">Estado:</label>
								<div class="col-sm-4 form-group">
									<select id="sel_est_uni" name="sel_est_uni" class="form-control">
										<option value="1">Activo</option>
										<option value="0">Inactivo</option>
									</select>
								</div>
...
<!-- Modal -->
<div id="div_marca" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" id="btn_clo_documentos" class="close" data-dismiss="modal" aria-hidden="true">
				...
				<h4 class="modal-title label-bold1" id="h4_tit_marca">Nueva Marca</h4>
			</div>
			
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 col-sm-12">
						<form id="frm_marca" class="form-horizontal" role="form">
							
							<input type="hidden" id="hid_id_marca" name="hid_id_marca">

							<div class="form-group">																				
								<label class="col-sm-2 control-label">Nombre:</label>
								<div class="col-sm-8 form-group">
									<input type="text" name="txt_nom_marca" id="txt_nom_marca" class="form-control">
								</div>
							</div>
...
<!-- 							</div> -->
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btn_gra_marca">
					<i class="fa fa-floppy-o"></i>
					Aceptar
				</button>
