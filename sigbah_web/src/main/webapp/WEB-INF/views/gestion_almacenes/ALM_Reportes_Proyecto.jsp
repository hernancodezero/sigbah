							...
							<form id="frm_rep_almacen" class="form-horizontal">
								...
								<div class="row">
									...
									<div class="col-sm-5 form-group">
										<select id="sel_producto" name="sel_producto" class="form-control" disabled>
...
<script src="${pageContext.request.contextPath}/resources/js/gestion_almacenes/listar_reportes_proyecto.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/gestion_almacenes/validacion_reportes_proyecto.js"></script>