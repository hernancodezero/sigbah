...
<div id="ribbon">
	...
	<ol class="breadcrumb">
		...
		<li>Consultas</li>
		<li>Historial de Movimientos de Ingreso</li>
	</ol>
	<!-- end breadcrumb -->
</div>
<!-- END RIBBON -->
			...
			<article class="col-xs-12 col-sm-12">
				...
				<div class="jarviswidget">
					<header>
						...
						<h2>Búsqueda de Historial de Movimientos de Ingreso</h2>
					</header>
...
<script src="${pageContext.request.contextPath}/resources/js/gestion_almacenes/listar_consulta_historial.js"></script>
