					...
					<header>
						...
						<div class="jarviswidget-ctrls" role="menu">   
							<a href="#" id="href_exp_copiar" class="button-icon" rel="tooltip" title="" data-placement="bottom" 
								data-original-title="Copiar Ración">
							...
							<a href="#" id="href_modal" class="button-icon" rel="tooltip" title="" data-placement="bottom" 
								data-original-title="Composición">
								<i class="fa fa-search"></i>
							</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title label-bold1" id="h4_tit_documentos">Composición de una Ración de Alimentos por Persona</h4>
			</div>
