...
$(document).ready(function() {
	...
	$('#href_imprimir').click(function(e) {
		...
		loadding(true);
		var url = VAR_CONTEXT + '/donaciones/consulta/exportarPdfFecha/'+idDdi+'/'+idAlmacen+'/'+nomDdi+'/'+nomAlmacen;
...
function inicializarDatos() {
  	...
  	$('#li_consultas_productos').addClass('active');
	$('#ul_donaciones').css('display', 'block');
	$('#ul_don_consultas').css('display', 'block');
	$('#li_consultas_productos').attr('class', 'active');
	$('#li_consultas_productos').closest('li').children('a');
...
//	cargarTitulo( idDdi, idAlmacen);
		...
		consultarAjax('GET', '/donaciones/consulta/listarProductos', params, function(respuesta) {
