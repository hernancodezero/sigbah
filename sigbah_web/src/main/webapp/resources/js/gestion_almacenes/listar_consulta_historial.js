...
$(document).ready(function() {
	...
	$('#btn_buscar').click(function(e) {
		...
		if (bootstrapValidator.isValid()) {
			...
			consultarAjax('GET', '/gestion-almacenes/consulta/listarHistorial', params, function(respuesta) {
...
function inicializarDatos() {
	...
	$('#li_consultas_historial_almacen').addClass('active');
	$('#ul_ges_almacenes').css('display', 'block');
	$('#ul_alm_consultas').css('display', 'block');
	$('#li_consultas_historial_almacen').attr('class', 'active');
	$('#li_consultas_historial_almacen').closest('li').children('a');
