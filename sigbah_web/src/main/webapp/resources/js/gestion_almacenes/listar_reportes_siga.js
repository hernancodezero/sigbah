...
$(document).ready(function() {
	...
	$('#btn_buscar').click(function(e) {
		...
		if (bootstrapValidatorRepAlmacen.isValid()) {
			...
			consultarAjax('GET', '/gestion-almacenes/reporte-almacen/exportarRepoSiga', params, function(respuesta) {
...
function inicializarDatos() {
	...
	$('#li_alm_rep_sig').attr('class', 'active');
	$('#li_alm_rep_sig').closest('li').children('a');
