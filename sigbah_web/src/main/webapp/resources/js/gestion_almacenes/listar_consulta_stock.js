...
$(document).ready(function() {
	...
	$('#href_imprimir').click(function(e) {
		...
		var idCategoria = $("#sel_categoria").val();
		loadding(true);
		var url = VAR_CONTEXT + '/gestion-almacenes/consulta/exportarPdf/'+idDdi+'/'+idAlmacen+'/'+nomDdi+'/'+nomAlmacen+'/'+idCategoria;
...
function inicializarDatos() {
  	...
  	$('#li_consultas_stock_almacen').addClass('active');
	$('#ul_ges_almacenes').css('display', 'block');
	$('#ul_alm_consultas').css('display', 'block');
	$('#li_consultas_stock_almacen').attr('class', 'active');
	$('#li_consultas_stock_almacen').closest('li').children('a');
...
function listarTablaStock(){
	...
	cargarTitulo( idDdi, idAlmacen);
		...
		var params = { 
			...
			tipoStock : $('#sel_tipo_stock').val()
		};
		
		loadding(true);
	
		consultarAjax('GET', '/gestion-almacenes/consulta/listarStock', params, function(respuesta) {
...
function cargarTitulo(idDdi, idAlmacen){
	...
	if(idDdi=='0' && idAlmacen=='0'){
		$('#txt_titulo').html("Stock "+$("#sel_tipo_stock option:selected").text()+" al "+fecha+" A nivel Nacional");
		$('#hid_titulo').val("Stock "+$("#sel_tipo_stock option:selected").text()+" al "+fecha+" A nivel Nacional");
	}else if(idDdi!='0' && idAlmacen=='0'){
		$('#txt_titulo').html("Stock "+$("#sel_tipo_stock option:selected").text()+" al "+fecha+" de la DDI: "+$("#sel_ddi option:selected").text());
		$('#hid_titulo').val("Stock "+$("#sel_tipo_stock option:selected").text()+" al "+fecha+" de la DDI: "+$("#sel_ddi option:selected").text())
	}else if(idDdi!='0' && idAlmacen!='0'){
		$('#txt_titulo').html("Stock "+$("#sel_tipo_stock option:selected").text()+" al "+fecha+" de la DDI: "+$("#sel_ddi option:selected").text()+" y Almacén: "+$("#sel_almacen option:selected").text());
		$('#hid_titulo').val("Stock "+$("#sel_tipo_stock option:selected").text()+" al "+fecha+" de la DDI: "+$("#sel_ddi option:selected").text()+" y Almacén: "+$("#sel_almacen option:selected").text())
	}
