...
/**
 * @className: RegistroGuiaRemisionDonacion2Mapper.java
 * @description: 
 * @date: 28 de jul. de 2018
 * @author: Alan Chumpitaz.
 */
public class RegistroGuiaRemisionDonacion2Mapper implements RowMapper<GuiaRemisionBean> {
	...
	public GuiaRemisionBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		guiaRemision.setObservacionGuiaRemision(rs.getString("OBSERVACION_GUIA")!=null?rs.getString("OBSERVACION_GUIA").replaceAll("[\n]", "<<E>>").replaceAll("\"", "<<D>>").replaceAll("\'", "<<S>>"):"");	
		guiaRemision.setObservacionManifiestoCarga(rs.getString("OBSERVACION_MANIFIESTO")!=null?rs.getString("OBSERVACION_MANIFIESTO").replaceAll("[\n]", "<<E>>").replaceAll("\"", "<<D>>").replaceAll("\'", "<<S>>"):"");	
		guiaRemision.setNroActaEntregaRecepcion(rs.getString("NRO_ACTA"));
		guiaRemision.setObservacionActaEntregaRecepcion(rs.getString("OBSERVACION_ACTA")!=null?rs.getString("OBSERVACION_ACTA").replaceAll("[\n]", "<<E>>").replaceAll("\"", "<<D>>").replaceAll("\'", "<<S>>"):"");	
