...
public class RegistroControlCalidadMapper implements RowMapper<ControlCalidadBean> {
	...
	public ControlCalidadBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		controlCalidad.setConclusiones(rs.getString("CONCLUSIONES")!=null?rs.getString("CONCLUSIONES").replace("/n", "&#10"):"");
		controlCalidad.setRecomendaciones(rs.getString("RECOMENDACIONES")!=null?rs.getString("RECOMENDACIONES").replace("/n", "&#10"):"");
		...
		controlCalidad.setRazonSocial(rs.getString("RAZON_SOCIAL"));
		controlCalidad.setRepresentante(rs.getString("REPRESENTANTE"));
