 ...
 * @author: ARCHY.
 */
public class MaeDistritoInei1Mapper implements RowMapper<MaeDistritoIneiBean> {
	...
	public MaeDistritoIneiBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		maeDistritoIneiBean.setPoblacion(rs.getInt("POBLACION_INEI"));
		maeDistritoIneiBean.setVivienda(rs.getInt("VIVIENDAS_INEI"));
