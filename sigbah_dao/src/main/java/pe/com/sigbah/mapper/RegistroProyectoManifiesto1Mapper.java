 ...
 */
public class RegistroProyectoManifiesto1Mapper implements RowMapper<ProyectoManifiestoBean> {
	...
	public ProyectoManifiestoBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		proyectoManifiesto.setObservacion(rs.getString("OBSERVACION")!=null?rs.getString("OBSERVACION").replaceAll("[\n]", "<<E>>").replaceAll("\"", "<<D>>").replaceAll("\'", "<<S>>"):"");	
