 ...
 */
public class ReporteSigaSMapper implements RowMapper<OrdenIngresoBean> {
	...
	public OrdenIngresoBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		ordenIngreso.setNombreAlmacenDestino(rs.getString("ALMACEN_DESTINO"));
		ordenIngreso.setDestino(rs.getString("DESTINO"));
