 ...
 * @author: whr.
 */
public class RegistroConsultaProgramacionMapper implements RowMapper<ProductoConsultaProductoBean> {
	...
	public ProductoConsultaProductoBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		emergencia.setPesoUniPres(rs.getBigDecimal("peso_und_pres"));
