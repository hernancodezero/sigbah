 ...
 * @author: ARCHY.
 */
public class ConsultaHistorialIngresoMapper implements RowMapper<ProductoIngresoBean> {
	...
	public ProductoIngresoBean mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		productoIngresoBean.setNroOrdenIngreso(rs.getString("NRO_ORDEN_INGRESO"));
		productoIngresoBean.setNroOrdenCompra(rs.getString("NRO_ORDEN_COMPRA"));
		productoIngresoBean.setNombreMovimiento(rs.getString("TIPO_MOVIMIENTO"));
		productoIngresoBean.setNombreAlmacenProcedencia(rs.getString("ALMACEN_ORIGEN"));
		...
		productoIngresoBean.setPesoTotalKgr(rs.getBigDecimal("KGRS_TOTAL"));
